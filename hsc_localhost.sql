...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 05, 2021 at 07:52 AM
...
CREATE TABLE `beacons_table` (
  `beacon_id` bigint(20) UNSIGNED NOT NULL,
  `beacon_type` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `locations_master_table` (
  ...
  'parent_Location_id' bigint(20) UNSIGNED NOT NULL,
...
ALTER TABLE `activity_log_table`
  ADD PRIMARY KEY (`log_id`,`gateway_id`,`beacon_id`),
...
ALTER TABLE `alerts_table`
  ADD PRIMARY KEY (`alert_id`,`reader_id`,`rules_id`,`user_id`),
...
ALTER TABLE `beacons_table`
  ADD PRIMARY KEY (`beacon_id`,`beacon_type`),
...
ALTER TABLE `gateways_table`
  ADD PRIMARY KEY (`gateway_id`,`location_id`),
...
ALTER TABLE `locations_master_table`
  ADD PRIMARY KEY (`location_master_id`,`location_type_id`),
...
ALTER TABLE `residents_table`
  ADD PRIMARY KEY (`resident_id`,`beacon_id`,`user_id`),
  ADD KEY `beacon_id` (`beacon_id`);
...
ALTER TABLE `users_table`
  ADD PRIMARY KEY (`user_id`,`type_id`,`alert_id`,`right_id`),
...
--
ALTER TABLE `gateways_table`
  ADD CONSTRAINT `gateways_table_ibfk_1` FOREIGN KEY (`location_id`) REFERENCES `locations_master_table` (`location_master_id`);
...
--
ALTER TABLE `residents_table`
  ADD CONSTRAINT `residents_table_ibfk_1` FOREIGN KEY (`beacon_id`) REFERENCES `beacons_table` (`beacon_id`);
